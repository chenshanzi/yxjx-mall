...
import org.linlinjava.litemall.wx.util.MailUtils;
...
public class WxOrderService {
    ...
    public Object payNotify(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<LitemallOrderGoods> goodsProducts = orderGoodsService.queryByOid(order.getId());
        //TODO 发送邮件和短信通知，这里采用异步发送
        // 订单支付成功以后，会发送短信给用户，以及发送邮件给管理员
        notifyService.notifyMail("新订单通知", MailUtils.getMailContent(order,goodsProducts));
