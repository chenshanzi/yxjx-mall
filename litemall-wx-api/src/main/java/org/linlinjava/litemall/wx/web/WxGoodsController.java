...
import org.linlinjava.litemall.wx.dto.LitemallGoodsDTO;
...
public class WxGoodsController {
	...
	public Object list(
		...
		List<LitemallGoodsDTO> goodsDTOList = Lists.newArrayList();
		goodsList.forEach(i->{
			LitemallGoodsDTO goodsDTO = Convert.convert(LitemallGoodsDTO.class,i);
			goodsDTO.setSpecificationList(goodsSpecificationService.getSpecificationVoList(i.getId()));
			goodsDTO.setProductList(productService.queryByGid(i.getId()));
