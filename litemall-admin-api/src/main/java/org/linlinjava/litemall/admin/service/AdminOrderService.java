...
public class AdminOrderService {
    ...
    @Autowired
    private LitemallUserService litemallUserServicel;
    ...
    public Object refund(String body) {
        ...
        if (!order.getOrderStatus().equals(OrderUtil.STATUS_REFUND)) {
            return ResponseUtil.fail(ORDER_CONFIRM_NOT_ALLOWED, "订单不是退款状态，不能进行退款");
        }
...
//                DateTimeUtil.getDateTimeDisplayString(order.getShipTime())
//        };
//        LitemallUser litemallUser = litemallUserServicel.findById(order.getUserId());
//        notifyService.notifyWxTemplate(litemallUser.getWeixinOpenid(), NotifyType.REFUND, parms);
...
//        String shipChannel = JacksonUtil.parseString(body, "shipChannel");
        ...
        LitemallUser litemallUser = litemallUserServicel.findById(order.getUserId());
        notifyService.notifyWxTemplate(litemallUser.getWeixinOpenid(), NotifyType.SHIP, parms, "pages/index/index?orderId=" + order.getId());
