...
public class NotifyService {
    ...
    public void notifyWxTemplate(String touser, NotifyType notifyType, String[] params) {
        ...
        wxTemplateSender.sendWechatMsg(touser, notifyType.getType(), templateId, params);
    }
    ...
    public void notifyWxTemplate(String touser, NotifyType notifyType, String[] params, String page) {
        ...
        String templateId = getTemplateId(notifyType, wxTemplate);
//        if ("app".equals(wxMsgMark)) {
//            wxTemplateSender.sendWeappMessage(touser, templateId, page, params);
//        } else {
        wxTemplateSender.sendWechatMsg(touser, notifyType.getType(), templateId, params, page);
//        }
    }
    ...
    public void setWxMsgMark(String wxMsgMark) {
        this.wxMsgMark = wxMsgMark;
    }
